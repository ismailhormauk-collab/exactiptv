...
import { ChevronRight, Sparkles, Tv2, Film, LayoutGrid, Star } from "lucide-react";
import { motion, useReducedMotion } from "framer-motion";
import type { HeroDict, Locale } from "@/locales/types";
import { localePath } from "@/lib/url";

/* ─── Floating particles around the mockup ───────────────────────── */
const particles = [
...
/* ─── Laptop mockup ─────────────────────────────────────────────── */
function LaptopMockup({ dict }: { dict: HeroDict }) {
    ...
    <div className="relative w-full max-w-[520px] mx-auto lg:mx-0">
      ...
      <motion.div {...float} style={{ willChange: "transform" }}>
        ...
        <motion.div
          ...
          style={{
            boxShadow: "0 30px 80px rgba(0,0,0,0.7), 0 0 60px rgba(59,130,246,0.14)",
          }}
        ...
        >
          ...
          <div className="rounded-[15px] overflow-hidden bg-[#080d1a] relative">
            ...
            {/* ── Shimmer sweep (light reflection) ── */}
            <motion.div
            ...
            <div className="px-6 py-5 bg-gradient-to-br from-[#0a0f20] via-[#080d1a] to-[#0c1022]">
              ...
              <div className="grid grid-cols-3 gap-2 mb-3">
                {[
                  { label: "LIVE WITH EPG", color: "border-blue-500/40 text-blue-400 bg-blue-500/10",    hover: "rgba(59,130,246,0.2)"   },
                  { label: "MULTI-SCREEN",  color: "border-violet-500/40 text-violet-400 bg-violet-500/10", hover: "rgba(139,92,246,0.2)" },
                  { label: "CATCH UP",      color: "border-cyan-500/40 text-cyan-400 bg-cyan-500/10",    hover: "rgba(6,182,212,0.2)"    },
                ].map(({ label, color }) => (
                  <motion.div
                    key={label}
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_65%_70%_at_90%_60%,rgba(37,99,235,0.22),transparent)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_40%_35%_at_100%_100%,rgba(6,182,212,0.1),transparent)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_55%_65%_at_0%_50%,rgba(109,40,217,0.22),transparent)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_35%_25%_at_35%_0%,rgba(139,92,246,0.12),transparent)]" />
